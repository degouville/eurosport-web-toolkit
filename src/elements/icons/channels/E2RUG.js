...
const E2RUGchannel = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 9" className={className}>
...
E2RUGchannel.displayName = 'E2RUGchannel';

export default E2RUGchannel;
