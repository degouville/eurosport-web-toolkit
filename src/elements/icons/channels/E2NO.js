...
const E2NOchannel = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 47 23" className={className}>
...
E2NOchannel.displayName = 'E2NOchannel';

export default E2NOchannel;
