...
const E2channel = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 15" className={className}>
...
E2channel.displayName = 'E2channel';

export default E2channel;
